...
## Structure
- `backend/` – Flask API using SQLAlchemy. It reads the database URL from the environment variable `DATABASE_URL` and supports a `.env` file for local configuration.
